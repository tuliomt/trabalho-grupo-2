	...
	$dataPoints4 = array(
    	array("label"=> "Janeiro", "y"=> 0.0026),
    	array("label"=> "Fevereiro", "y"=> 0.0026),
    	array("label"=> "Março", "y"=> 0.0026),
    	array("label"=> "Abril", "y"=> 0.0026),
    	array("label"=> "Maio", "y"=> 0.0026),
    	array("label"=> "Junho", "y"=> 0.0026),
    	array("label"=> "Julho", "y"=> 0.0026),
    	array("label"=> "Agosto", "y"=> 0.0026),
    	array("label"=> "Setembro", "y"=> 0.0026),
    	array("label"=> "Outubro", "y"=> 0.0025),
    	array("label"=> "Novembro", "y"=> 0.0025),
    	array("label"=> "Dezembro", "y"=> 0.0025)
    );
